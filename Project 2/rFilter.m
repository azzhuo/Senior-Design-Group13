function [BW,maskedRGBImage] = rFilter(RGB)
...
shiftVec = [0.005399 0.013864 0.655320];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [0.745504 -0.106221 0.000000 -0.454187;
    0.065684 1.205592 0.000000 -0.541954;
    0.000000 0.000000 -0.762986 9.160254;
...
hPoints(1).data = [-0.414042 -0.502142;
    -0.213319 -0.083476;
    0.051986 -0.255566;
    0.086894 -0.766698;
    0.020568 -1.020980;
